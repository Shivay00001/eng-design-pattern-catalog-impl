...
Engineering design patterns catalog — Go & Python impls with CI/CD and Docker.
...
Welcome to the **Eng Design Pattern Catalog Impl** repository. This project is built to deliver a robust and scalable solution tailored to modern development standards.
...
1. Clone the repository:
   ```bash
   git clone https://github.com/Shivay00001/eng-design-pattern-catalog-impl.git
   ```
2. Navigate to the project directory:
   ```bash
   cd eng-design-pattern-catalog-impl
   ```
